...
public class Section1Fragment extends Fragment {
    ...
    private RecyclerView mRecyclerPicture;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mContext = getContext();
        mRecyclerPicture = view.findViewById(R.id.recycler_section1);
        setupUI(container);
        return view;
    }
    ...
    private void setupUI(ViewGroup container) {
        ...
        mRecyclerPicture.setLayoutManager(mStaggeredGridLayoutManager);
    }
